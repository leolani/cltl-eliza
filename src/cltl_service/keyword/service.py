...
class KeywordService:
    ...
    def from_config(cls, emissor_client: EmissorDataClient,
        ...
        config = config_manager.get_config("cltl.eliza.keyword")
        topics = {
        ...
        return cls(topics, intentions, emissor_client, event_bus, resource_manager)

    def __init__(self, topics: Mapping[str, str], intentions: List[str],
